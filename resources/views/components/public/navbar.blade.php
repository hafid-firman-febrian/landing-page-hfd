<header class="sticky top-0 z-50 border-b border-primary/10 bg-background/85 backdrop-blur">
    <nav class="mx-auto max-w-6xl px-4 h-16 flex items-center sm:justify-center">
        ...
        <div class="hidden sm:flex items-center gap-8 text-sm text-ink-700">
        ...
        <button data-menu-toggle class="sm:hidden text-primary text-2xl leading-none" aria-label="Buka menu"><i class="fa-solid fa-bars"></i></button>
    </nav>
